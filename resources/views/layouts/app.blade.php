...
<body class="light bg-slate-200/75 dark:bg-slate-800">

<!-- ========== HEADER ========== -->
<header
    class="sticky top-0 inset-x-0 flex flex-wrap sm:justify-start sm:flex-nowrap z-[48] w-full bg-white shadow-sm dark:bg-slate-900 text-sm py-2.5 sm:py-4 lg:ps-64 dark:bg-neutral-800 dark:border-neutral-700">
    <nav class="flex basis-full items-center w-full mx-auto px-4 sm:px-6" aria-label="Global">
        ...
        <div class="w-full flex items-center justify-end ms-auto sm:gap-x-3 sm:order-3">
            ...
            <div class="flex flex-row items-center justify-end gap-2">
                ...
                <button type="button"
                        class="hs-dark-mode-active:hidden w-[2.375rem] h-[2.375rem] inline-flex justify-center items-center gap-x-2 text-sm font-semibold rounded-full border border-transparent text-gray-800 hover:bg-gray-100 disabled:opacity-50 disabled:pointer-events-none dark:text-white dark:hover:bg-neutral-700"
                ...
                <div class="hs-dropdown [--placement:bottom-right] relative inline-flex">
                    ...
                    <div
                        ...
                        <div class="mt-2 py-2 first:pt-0 last:pb-0">
                            ...
                            <form method="POST"
                                  class="flex items-center gap-x-3.5 py-2 px-2 rounded-lg text-sm text-gray-800 hover:bg-gray-100 focus:ring-2 focus:ring-blue-500 dark:text-neutral-400 dark:hover:bg-neutral-700 dark:hover:text-neutral-300"
                                  action="{{ route('logout') }}">
                                @csrf
...
<!-- Breadcrumb -->
<div
    class="sticky top-0 inset-x-0 z-20 bg-white border-y px-4 sm:px-6 md:px-8 lg:hidden dark:bg-slate-800 dark:border-neutral-700">
...
<div id="application-sidebar" class="shadow-md hs-overlay [--auto-close:lg]
 ...
 ">
    <div class="px-8 py-2.5 flex justify-center">
        <!-- Logo -->
        <a class="flex-none text-lg inline-block font-semibold focus:outline-none focus:opacity-80 dark:text-white"
