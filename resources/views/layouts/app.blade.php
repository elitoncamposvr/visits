...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <x-mary-nav sticky full-width>
        ...
        <x-slot:brand>
            ...
            {{-- Brand --}}
            <div class="font-semibold text-xl">APLICATIVO VISITAS</div>
        </x-slot:brand>
...
{{--            <x-mary-button icon="o-power" class="btn-circle btn-ghost btn-xs" tooltip-left="logoff" no-wire-navigate link="/logout" />--}}
            <form method="POST" action="{{ route('logout') }}">
                ...
                <x-mary-button icon="o-power" class="btn-circle btn-ghost btn-xs" :href="route('logout')"
    ...
    <x-mary-main with-nav full-width>
        ...
        <x-slot:sidebar drawer="main-drawer" collapsible class="bg-base-200">
            ...
            <x-mary-menu activate-by-route>
                ...
                <x-mary-menu-item title="Usuários" icon="o-user" link="/users" />
                <x-mary-menu-item title="Visitas" icon="o-newspaper" link="/" />
                <x-mary-menu-sub title="Configurações" icon="o-cog-6-tooth">
                    <x-mary-menu-item title="Usuários" icon="o-user" link="####" />
                    <x-mary-menu-item title="Arquivos" icon="o-archive-box" link="####" />
                </x-mary-menu-sub>
            </x-mary-menu>
        </x-slot:sidebar>
