                            ...
                            <div class="inline-flex gap-x-2">
                                <span>
                                    <form action="{{ route('companies.search') }}" method="post">
                                        @csrf
                                        <input type="search" name="search" id="search" placeholder="Pesquisar Empresa">
                                    </form>
                                </span>
                                <a class="py-2 px-3 inline-flex items-center gap-x-2 text-sm font-semibold rounded-lg border border-transparent bg-blue-600 text-white hover:bg-blue-700 disabled:opacity-50 disabled:pointer-events-none" href="{{ route('companies.create') }}">
                        ...
                        <div class="w-full flex items-center px-2 text-sm py-3 border-b border-gray-200">
                            <div class="w-1/12 text-center">
                                ...
                                <span class="inline-flex items-center justify-center size-[38px] rounded-full bg-white border border-gray-300 bg-slate-200 dark:bg-neutral-800 dark:border-neutral-700">
                                    <span class="font-medium text-sm text-gray-800 leading-none dark:text-neutral-200">{{ Str::of($company->name)->substr(0,1) }}</span>
                                </span>
